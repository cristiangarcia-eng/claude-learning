...
export const LESSONS: LessonMeta[] = [
  ...
  },
  {
    ...
    description: "Shortcuts to control Claude Code behavior — /help, /memory, /compact, and more",
    descriptionEs: "Atajos para controlar el comportamiento de Claude Code — /help, /memory, /compact y mas",
    level: "pro",
    duration: "10 min",
    complexity: 2,
    order: 11,
  ...
  },
  {
    ...
    title: "Hooks",
    titleEs: "Hooks",
    description: "Automated scripts that execute on Claude Code events for validation, permissions, and workflows",
    descriptionEs: "Scripts automatizados que se ejecutan en eventos de Claude Code para validacion, permisos y flujos de trabajo",
    level: "pro",
    duration: "12 min",
    complexity: 3,
    order: 15,
  ...
  },
  {
    ...
    description: "Real tasks for PMs, designers, and sales — no coding experience needed",
    descriptionEs: "Tareas reales para PMs, disenadores y ventas — sin experiencia en codigo",
    level: "pro",
    duration: "10 min",
    complexity: 2,
    order: 21,
  ...
  {
    folder: "00g-git-basics",
    slug: "git-basics",
    title: "Git Basics",
    titleEs: "Fundamentos de Git",
    description: "Understand repositories, commits, and the 5 commands Claude uses behind the scenes",
    descriptionEs: "Entiende repositorios, commits y los 5 comandos que Claude usa detras de escena",
    level: "pro",
    duration: "10 min",
    complexity: 2,
    order: 22,
  },
  {
    ...
    title: "CLI Usage",
    titleEs: "Uso del CLI",
    description: "Essential Claude Code terminal commands, sessions, and model selection for daily work",
    descriptionEs: "Comandos esenciales de Claude Code en terminal, sesiones y seleccion de modelo para el dia a dia",
    level: "pro",
    duration: "8 min",
    complexity: 2,
    order: 23,
  },
  {
    ...
    titleEs: "Funciones Avanzadas",
    description: "Planning mode, extended thinking, auto mode, voice, remote control, and session management",
    descriptionEs: "Modo plan, pensamiento extendido, modo auto, voz, control remoto y gestion de sesiones",
    level: "pro",
    duration: "12 min",
    complexity: 3,
    order: 24,
  },
  {
    ...
    slug: "planning-mode",
    title: "Planning Mode",
    titleEs: "Modo de Planificacion",
    description: "Create step-by-step plans for review before Claude takes action",
    descriptionEs: "Crea planes paso a paso para revisar antes de que Claude actue",
    level: "pro",
    duration: "8 min",
    complexity: 2,
    order: 25,
