...
export interface LessonMeta {
  ...
  level: "starter" | "pro" | "projects" | "extra";
  duration: string;
...
export const LESSONS: LessonMeta[] = [
  ...
  },
  {
    ...
    slug: "quickstart",
    title: "Install & Open Claude Code",
    titleEs: "Instalar y Abrir Claude Code",
    description: "Install Claude Code, open it in Cursor, and have your first conversation",
    descriptionEs: "Instala Claude Code, ábrelo en Cursor y ten tu primera conversación",
    level: "starter",
    duration: "10 min",
    complexity: 1,
    order: 3,
  ...
  {
    folder: "17-optimize-tokens",
    slug: "optimize-tokens",
    title: "Optimize Tokens",
    titleEs: "Optimizar Tokens",
    description: "Techniques to reduce token usage without sacrificing quality",
    descriptionEs: "Técnicas para reducir el consumo de tokens sin sacrificar calidad",
    level: "extra",
    duration: "8 min",
    complexity: 2,
    order: 16,
