...
export const LESSONS: LessonMeta[] = [
  ...
  {
    folder: "11-exercises/07-screenshots-to-spec",
  ...
  {
    folder: "11-exercises/08-prioritize-from-chaos",
    slug: "project-prioritize",
    title: "Prioritize from Chaos",
    titleEs: "Priorizar desde el Caos",
    description: "Design a framework, discover it fails, redesign in Plan Mode — the iteration loop",
    descriptionEs: "Diseña un framework, descubre que falla, rediseña en Plan Mode — el ciclo de iteración",
    level: "projects",
    duration: "35 min",
    complexity: 3,
    order: 27,
  ...
  {
    folder: "11-exercises/09-folder-audit",
