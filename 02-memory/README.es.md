...
**Modo interactivo mejorado:** Set `CLAUDE_CODE_NEW_INIT=true` to enable a multi-phase interactive flow that walks you through project setup step by step:
...
| **Cuando usar** | Update/modify project context | Begin new projects |
...
**Usando Importaciones de Memoria:**
...
## Excluyendo Archivos CLAUDE.md with `claudeMdExcludes`
...
### Reglas por Ruta con YAML Frontmatter
...
### Compartir entre Worktrees y Repositorios
...
## Directorios Adicionales with `--add-dir`
...
### Consejos para Gestionar la Memoria
...
### Configurar Memoria por Directorio
