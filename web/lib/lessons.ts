...
export const LESSONS: LessonMeta[] = [
  ...
  {
    folder: "11-exercises/exercise-01-context-engineering",
  ...
  {
    folder: "11-exercises/exercise-02-messy-spreadsheet",
  ...
  {
    folder: "11-exercises/exercise-03-research-landscape",
    slug: "project-research-landscape",
    title: "Market Research",
    titleEs: "Investigación de Mercado",
    description: "Build a research skill that activates automatically",
    descriptionEs: "Crea un skill de investigación que se activa automáticamente",
    level: "projects",
    duration: "30 min",
    complexity: 2,
    order: 22,
  ...
  {
    folder: "11-exercises/exercise-04-taxonomy-from-chaos",
  ...
  {
    folder: "11-exercises/exercise-05-conversation-analysis",
  ...
  {
    folder: "11-exercises/exercise-06-evaluate-ai-output",
  ...
  {
    folder: "11-exercises/exercise-07-screenshots-to-spec",
    slug: "project-notes-to-spec",
    title: "Notes to Spec",
    titleEs: "Notas a Especificación",
    description: "Use Plan Mode to structure rough notes into a formal spec",
    descriptionEs: "Usa el Modo Plan para estructurar notas sueltas en una especificación formal",
    level: "projects",
    duration: "30 min",
    complexity: 2,
    order: 26,
  ...
  {
    folder: "11-exercises/exercise-08-prioritize-from-chaos",
    slug: "project-prioritize",
    title: "Prioritize from Chaos",
    titleEs: "Priorizar desde el Caos",
    description: "Design a scoring framework with Plan Mode to prioritize 60 requests",
    descriptionEs: "Diseña un framework de puntuación con Modo Plan para priorizar 60 solicitudes",
    level: "projects",
    duration: "40 min",
    complexity: 2,
    order: 27,
  ...
  {
    folder: "11-exercises/exercise-09-folder-audit",
    slug: "project-folder-audit",
    title: "Folder Audit",
    titleEs: "Auditoría de Carpeta",
    description: "Use CLI print mode to audit documents in batch",
    descriptionEs: "Usa el modo print de CLI para auditar documentos por lotes",
    level: "projects",
    duration: "30 min",
    complexity: 3,
    order: 28,
  ...
  {
    folder: "11-exercises/exercise-10-end-to-end-pipeline",
  ...
  {
    folder: "11-exercises/exercise-11-connect-systems",
    slug: "project-connect-systems",
    title: "Connect Systems",
    titleEs: "Conectar Sistemas",
    description: "Use Fetch MCP to pull competitor data and combine with local files",
    descriptionEs: "Usa Fetch MCP para obtener datos de competidores y combinar con archivos locales",
    level: "projects",
    duration: "30 min",
    complexity: 2,
    order: 30,
