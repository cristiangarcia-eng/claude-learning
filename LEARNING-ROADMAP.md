...
> **Before you begin**: Make sure you've completed the foundational modules (00-series). In particular, if you've never used Git, complete [Git Basics](00g-git-basics/) first — Claude Code uses Git concepts like commits, branches, and diffs throughout the course.
